...
from SInst.RuleInst.CheckAndParseInstInfo import extract_and_parse
from SInst.RuleInst.extract_data_from_GPT_response import get_inst_name_from_raw_file_path, extract_a_text_to_json
...
def get_structured_json_path(last_fpaths:QueryFileNames):
    ...
    stem = get_inst_name_from_raw_file_path(responst_txt_path)
