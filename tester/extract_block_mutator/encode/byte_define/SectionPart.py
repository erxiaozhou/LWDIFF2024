...
def gen_fix_content_encoder(encoder_name, encoding, encoded):
    ...
    return gen_decoder_by_type_desc_reprs(
        ...
        to_ir_component_func=lambda x : encoded,
...
gen_from_desc_dict(raw_desc_dict, 'functype',
    to_ir_component_func =lambda x:  funcTypeFactory.generate_one_func_type_default(
...
EmptyBlockTypePart = gen_decoder_by_type_desc_reprs(
    ...
    to_ir_component_func = lambda x:True,
)
...
BlockTypePart = gen_decoder_by_type_desc_reprs(
    ...
    to_ir_component_func = lambda x:Blocktype(x['blocktype']),
...
InstD = gen_common_decoder(
    part_desc=PartDesc(
        ...
        to_ir_component_func=lambda data: data['inst'],
        to_payload_func= lambda x: DataPayloadwithName(
            data={'inst': x},
            name=x.opcode_text
        ),
...
gen_from_desc_dict(raw_desc_dict, 'elemkind',
    to_ir_component_func = lambda x: 'funcref',
    to_payload_func= lambda x: DataPayloadwithName(
        data={'val': 'funcref'},
        name='elemkind'
    ))
...
type_sec_decoder = gen_from_desc_dict(raw_desc_dict, 'typesec',
    to_ir_component_func= lambda data: data['ft'],
    is_section=True
)

function_sec_decoder = gen_from_desc_dict(raw_desc_dict, 'function_section',
    to_ir_component_func= lambda data: data['section_content'],
    is_section=True
)
...
memory_sec_decoder=gen_from_desc_dict(raw_desc_dict, 'memory_section', 
    to_ir_component_func= lambda data: data['memories'],is_section=True)

gen_from_desc_dict(raw_desc_dict, 'table')


table_sec_decoder=gen_from_desc_dict(raw_desc_dict, 'tablesec', 
    to_ir_component_func= lambda data: data['tables'],is_section=True)



global_sec_decoder=gen_from_desc_dict(raw_desc_dict, 'global_section',
    to_ir_component_func= lambda data: data['globals'],
    is_section=True
)
...
start_sec_decoder = gen_from_desc_dict(
    ...
    is_section=True,
    to_ir_component_func= lambda data: data['start_function']
)


export_sec_decoder = gen_from_desc_dict(
    raw_desc_dict, 'export_section',
    to_ir_component_func= lambda data: data['exports'],
    is_section=True,
)
...
import_sec_decoer=gen_from_desc_dict(raw_desc_dict, 'import_section', 
    to_ir_component_func= lambda data: data['imports'],is_section=True)


data_count_sec_decoder = gen_from_desc_dict(
    raw_desc_dict, 'data_count_section',
    is_section=True,
    to_ir_component_func= lambda data: data['n']
)
...
elem_sec_decoder = gen_from_desc_dict(
    ...
    is_section=True,
    to_ir_component_func= lambda data: data['element_segments']
)
...
data_sec_decoder = gen_from_desc_dict(
    ...
    is_section=True,
    to_ir_component_func= lambda data: data['data_segments']
)
...
code_sec_decoder = gen_from_desc_dict(
    ...
    is_section=True,
    to_ir_component_func= lambda data: data['code_entries']
)
...
module_decoder = gen_decoder_by_type_desc_reprs(
    type_desc_reprs=[
        ...
        decoder_name='Module',
        to_ir_component_func= lambda data: data['sections'],
)
