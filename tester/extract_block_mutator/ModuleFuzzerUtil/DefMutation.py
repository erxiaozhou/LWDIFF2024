...
class Mutation:
    ...
    def can_apply(self, wasm_parser:WasmParser):
        return self.apply_condition_func(wasm_parser)
    
    def apply(self, wasm_parser:WasmParser):
        return self.apply_func(wasm_parser)
