...
from ..CPlaceHolder import is_valid_imm_name
from ..CPlaceHolder import ImmPH, OperandPH, is_op_ty_desc_str
from ..SelectFuncConstraintFactory import SelectFuncConstraintFactory


class ImEqOpTypeIMConstraint(IMConstraint):  # just in the typed `select` instruction
    ...
    def release_both_constraints(self, ph_env:PHEnv, *args, **kwds)->List[IMConstraintResult]:
        try:
            ...
            val_c = ExprConstraintFactory.from_exprs_directly(imm_ph, symbolized_type_val,InstValRelation.EQ)
